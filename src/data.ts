...
export const PROJECTS = [
  {
    ...
    desc: 'A full-stack multiplayer gaming platform with real-time gameplay, Elo-based rankings, and social features. Built with TypeScript, React, Node.js, and MongoDB.',
    live: 'https://gameniteserver-production.up.railway.app',
    github: 'https://github.com/kashvime/gamenite',
    readme: {
      overview:
        'A full-stack multiplayer gaming platform supporting Chess, Nim, and Guess. Built with a generic `GameLogic<State, View>` interface so each new game only touches one file per layer — the architecture enforces separation of concerns at compile time.',
      sections: [
        {
          title: 'Architecture',
          points: [
  ...
  {
    num: '02',
    name: 'Speech Emotion Classifier',
    year: '2025',
    ...
    readme: {
      overview:
        'An end-to-end audio classification pipeline that takes raw `.wav` files, extracts acoustic features, and runs inference across four model architectures selectable at runtime via a Streamlit interface.',
      sections: [
        {
          title: 'Pipeline',
          points: [
  ...
  },
  {
    ...
    readme: {
      overview:
        'A full-stack health tracking app built in 48 hours at HackBeanpot 2025. Users log nicotine use events via REST API; the backend persists them as an immutable event log in MongoDB, enabling full timeline reconstruction and state replay.',
      sections: [
        {
          title: 'Architecture',
          points: [
...
export const SKILL_GRAPH: Record<
  string,
  { how: string; connections: SkillConnection[] }
> = {
  Python: {
    ...
    connections: [
      {
        ...
        detail:
          'Automated 30+ clinical site reports; modular SQL validation tools',
      },
      {
        type: 'experience',
        name: 'Northeastern University',
        detail: 'ETL pipeline cutting preprocessing by ~3 hrs/dataset',
      },
      {
        type: 'project',
        name: 'Speech Emotion Classification',
        detail: 'MFCC & mel-spectrogram feature extraction + model training',
      },
    ],
  },
  TypeScript: {
    ...
    connections: [
      {
        ...
        name: 'GameNite',
        detail:
          'GameLogic<State,View> interface; type-safe REST + Socket events',
      },
      {
        type: 'course',
        name: 'CS 4530 · Software Engineering',
        detail: 'Semester-long TypeScript project with Agile sprints',
      },
    ],
  },
  React: {
    ...
    connections: [
      {
        type: 'project',
        name: 'GameNite',
        detail: 'Real-time game UI synced live via Socket.io',
      },
      {
        type: 'project',
        name: 'Nicotine Use Monitor',
        detail: 'MERN stack frontend built in 48 hours',
      },
      {
        type: 'course',
        name: 'CS 4530 · Software Engineering',
        detail: 'Component architecture + testing pyramid',
      },
    ],
  },
  'Node.js': {
    ...
    connections: [
      {
        type: 'project',
        name: 'GameNite',
        detail: 'Socket.io game rooms, Elo engine, REST API',
      },
      {
        type: 'project',
        name: 'Nicotine Use Monitor',
        detail: 'Express + MongoDB backend in 48 hours',
      },
    ],
  },
  MongoDB: {
    ...
    connections: [
      {
        type: 'project',
        name: 'GameNite',
        detail: 'Player stats, league rankings, game history',
      },
      {
        type: 'project',
        name: 'Nicotine Use Monitor',
        detail: 'Immutable event log with timeline reconstruction',
      },
    ],
  },
  'Socket.io': {
    ...
    connections: [
      {
        type: 'project',
        name: 'GameNite',
        detail: 'Live game rooms: player joins, move broadcasting, spectating',
      },
    ],
  },
  PyTorch: {
    ...
    connections: [
      {
        type: 'project',
        name: 'Speech Emotion Classification',
        detail: 'CNN with mel-spectrogram inputs → 0.98 macro-F1',
      },
      {
        type: 'course',
        name: 'CS 4420 · Machine Learning',
        detail: 'Neural nets, backpropagation, training loops',
      },
    ],
  },
  'scikit-learn': {
    ...
    connections: [
      {
        type: 'project',
        name: 'Speech Emotion Classification',
        detail: 'SVM, KNN, MLP baselines compared against CNN',
      },
    ],
  },
  SQL: {
    ...
    connections: [
      {
        type: 'experience',
        name: 'Massachusetts General Hospital',
        detail: 'Reduced manual review by 80% with modular validation queries',
      },
      {
        type: 'experience',
        name: 'Northeastern University',
        detail: 'Data extraction for multi-format ETL pipeline',
      },
    ],
  },
  AWS: {
    ...
    connections: [
      {
        type: 'experience',
        name: 'Brain Game Center · Northeastern',
        detail: 'Audited datasets for a double-blind cognitive study',
      },
      {
        type: 'experience',
        name: 'Massachusetts General Hospital',
        detail: 'LLM tooling exploration on cloud infrastructure',
      },
    ],
  },
  R: {
    ...
    connections: [
      {
        ...
        name: 'Brain Game Center · Northeastern',
        detail:
          'Cross-platform consistency validation; presented at Research Expo',
      },
    ],
  },
  Playwright: {
    ...
    connections: [
      {
        type: 'project',
        name: 'GameNite',
        detail: 'E2E tests: room creation, joins, full game flows',
      },
      {
        type: 'course',
        name: 'CS 4530 · Software Engineering',
        detail: 'Testing pyramid: unit → integration → E2E',
      },
    ],
  },
  Java: {
    ...
    connections: [
      {
        ...
        detail: 'Design patterns, inheritance, interfaces',
      },
      {
        type: 'course',
        name: 'CS 2510 · Fundamentals of CS 2',
        detail: 'Algorithmic problem solving in Java',
      },
    ],
  },
  Git: {
    ...
    connections: [
      {
        type: 'project',
        name: 'GameNite',
        detail: 'Feature branches, PRs, semantic commits',
      },
      {
        type: 'course',
        name: 'CS 4530 · Software Engineering',
        detail: 'Agile team Git workflow with code reviews',
      },
    ],
  },
  JavaScript: {
    ...
    connections: [
      {
        type: 'project',
        name: 'GameNite',
        detail: 'Async Socket.io handlers, game state management',
      },
      {
        type: 'project',
        name: 'Nicotine Use Monitor',
        detail: 'MERN stack, built end-to-end in 48 hours',
      },
    ],
  },
}
