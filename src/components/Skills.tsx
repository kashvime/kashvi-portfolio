...
function makeArrow(
  ...
  const sx = src.right - cr.left,
    sy = src.top - cr.top + src.height / 2
  const dx = dst.left - cr.left,
    dy = dst.top - cr.top + dst.height / 2
  const mx = (sx + dx) / 2
  return {
...
export default function Skills() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={headerRef}
        style={{ padding: isMobile ? '40px 20px 0' : '64px 40px 0' }}
      >
        <motion.span
          initial={{ opacity: 0 }}
        ...
        <div style={{ overflow: 'hidden', paddingBottom: '28px' }}>
          {['SKILLS'].map((word, i) => (
      ...
      <div
        ref={containerRef}
        style={{
          padding: isMobile ? '20px 20px 36px' : '28px 40px 56px',
          position: 'relative',
        }}
      >
        <svg
        ...
        >
              ...
              {skillKeys.map((skill, i) => {
                ...
                return (
                  <motion.button
                    key={skill}
                    ref={(el) => {
                      if (el) tagRefs.current.set(skill, el)
                    }}
                    ...
                    style={{
                      ...
                      boxShadow: isSel
                        ? `0 4px 16px rgba(224,90,130,0.25)`
                        : 'none',
          ...
          <div
            style={{
              ...
              transform: isMobile ? 'none' : 'translateY(-48px)',
            }}
          >
                      ...
                      return (
                        <motion.div
                          ...
                          style={{
                            ...
                            background: `linear-gradient(135deg, ${color}12, rgba(255,255,255,0.45))`,
